...
// ANSWER: I could make it easier to read, but I don't think i could come up with one that has a better time complexity than O(1)
...
// ANSWER: This function is more like O(3n), I can think of O(2n) function but I can't think of one that would reduce the complexity to O(1) or O(log(n))
...
// ANSWER: There's only 26 letters of the alphabet, so while the for loop has the power to create new properties, it can't make more than 26. 
//The first function makes a lot of stuff, but none of its functions have power to make more potentially infinite objects/arrays
